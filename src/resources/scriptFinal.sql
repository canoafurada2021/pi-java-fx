...
CREATE TABLE IF NOT EXISTS `aluguelRegistros` (
  ...
  `veiculo_id_veiculo` INT NOT NULL,  -- Adiciona a coluna veiculo_id_veiculo
  PRIMARY KEY (
    `id_venda`,
...
insert into aluguelRegistros (id_venda, forma_pagamento, data_inicio, quant_dias, valor, vendedor_id_vendedor, locador_pessoas_cpf, veiculo_id_veiculo) values (12, 'Cartão de Crédito em 5 vezes', '2005-10-24', 3, 300, 1, 212213454, 1);
