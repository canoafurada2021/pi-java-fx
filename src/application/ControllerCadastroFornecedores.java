...
//			}
	...
	public void abrirListProdutos(ActionEvent event) {
		try {
	...
	public void abrirListLocacao(ActionEvent event) {
		try {
	...
	public void abrirListClientes(ActionEvent event) {
		try {
	...
	public void abrirListCategorias(ActionEvent event) {
		try {
	...
	public void abrirDConfiguracoes(ActionEvent event) {
		try {
