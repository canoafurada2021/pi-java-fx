...
public class ControllerTableViewFuncionarios implements Initializable {
	...
	private void abrirModalExclusao(Vendedor vendedor) {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/visao/PopUpProsseguirExclusao.fxml"));
			Parent root = loader.load();

			ControllerModalExclusao controllerModalExclusao = loader.getController();
			controllerModalExclusao.setVendedor(vendedor);  // Passar o vendedor
